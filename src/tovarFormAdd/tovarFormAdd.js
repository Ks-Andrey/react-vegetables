        ...
        return(
                <form className="form">
                    <div className="form-group mb-3">
                        <input value={name} onChange={(e) => this.onChangeInput(e, "name")} type="text" id="weight" className="form-control" placeholder="Введите название продукта"/>
                    </div>
                    <div className="form-group mb-3">
                        <input onChange={(e) => this.onChangeInput(e, "img")} type="file" id="weight" className="form-control" placeholder="Вставьте ссылку на продукт"/>
                    </div>
                    <div className="form-group">
                        <button onClick={(e) => this.addNewTovar(name, img, e)} className="w-100 mw-100 btn btn-primary">Добавить</button>
                    </div>
                </form>
        );
    }
