            ...
            <div className="form-container">
                ...
                <form className="form" onSubmit={(e) => {this.onSellTovar(e)}}>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input type="text" value={weight} onChange={(e) => this.getFormData(e, 'weight')} id="weight" className="form-control" />
                        </div>
                        <div className="form-group mb-3">
                            <label htmlFor="price" className="mb-1">Цена</label>
                            <input type="text" value={price} onChange={(e) => this.getFormData(e, 'price')} id="price" className="form-control" />
                        </div>
